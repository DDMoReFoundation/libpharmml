    ...
    extends CommonVariableDefinition implements Assignable
{
    ...
    /**
     * Gets the value of the regressor property.
     * 
     * @return
     *     possible object is
     *     {@link RegressorType }
     ...
     * @since PharmML 0.7
     */
    public RegressorType getRegressor() {
        return regressor;
    }

    /**
     * Sets the value of the regressor property.
     * 
     * @param value
     *     allowed object is
     *     {@link RegressorType }
     ...
     * @since PharmML 0.7
     */
    public void setRegressor(RegressorType value) {
