    ...
    extends PharmMLRootType
{
    ...
    public SymbolRef createSymbolRef(String symbIdRef){
    	SymbolRef sref = new SymbolRef();
    	sref.setSymbIdRef(symbIdRef);
    	getListOfSymbRef().add(sref);
    	return sref;
    }
    
    public SymbolRef createSymbolRef(String symbIdRef, String blkIdRef){
    	SymbolRef sref = new SymbolRef();
    	sref.setSymbIdRef(symbIdRef);
    	sref.setBlkIdRef(blkIdRef);
    	getListOfSymbRef().add(sref);
    	return sref;
    }
