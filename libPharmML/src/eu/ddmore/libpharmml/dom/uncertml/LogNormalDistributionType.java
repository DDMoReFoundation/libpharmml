 ...
 *       &lt;sequence>
 *         &lt;element name="logScale" type="{http://www.uncertml.org/3.0}ContinuousValueType"/>
...
{
	@XmlTransient
	public static java.lang.String DEFINITION_ELEMENT_URI = "log-normal";
    ...
    protected ContinuousValueType logScale;
    @XmlElement(required = true)
     ...
     *     
     */
    public ContinuousValueType getLogScale() {
        return logScale;
    }
     ...
     *     
     */
    public void setLogScale(ContinuousValueType value) {
        this.logScale = value;
    }
