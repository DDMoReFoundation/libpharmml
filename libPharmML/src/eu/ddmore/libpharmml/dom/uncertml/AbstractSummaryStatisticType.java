...
/**
 * <p>Java class for AbstractSummaryStatisticType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AbstractSummaryStatisticType">
 *   &lt;complexContent>
...
@XmlSeeAlso({
    QuantileType.class,
    VarianceType.class,
    CategoricalProbabilityValueType.class,
    RangeType.class,
    MomentType.class,
    SkewnessType.class,
    CoefficientOfVariationType.class,
    MedianType.class,
    ConfidenceIntervalType.class,
    InterquartileRangeType.class,
    CredibleIntervalType.class,
    KurtosisType.class,
    CorrelationType.class,
    QuartileType.class,
    MeanType.class,
    ModeType.class,
    StatisticsCollectionType.class,
    PercentileType.class,
    CentredMomentType.class,
    DecileType.class,
    DiscreteProbabilityType.class,
    StandardDeviationType.class,
