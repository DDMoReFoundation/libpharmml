 ...
 *             
 * 
 * <p>Java class for InterventionsReferenceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InterventionsReferenceType">
 *   &lt;complexContent>
...
@XmlType(name = "InterventionsReferenceType", propOrder = {
    "listOfOidRef"
})
public class InterventionsReference
    extends PharmMLRootType implements ReferenceContainer
{
    ...
    protected List<TreeNode> listChildren() {
    	return new ChainedList<TreeNode>(super.listChildren()).addIfNotNull(listOfOidRef);
    }
